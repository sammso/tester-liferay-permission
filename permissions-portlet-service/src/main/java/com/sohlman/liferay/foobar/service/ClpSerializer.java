...
import com.sohlman.liferay.foobar.model.BarClp;
import com.sohlman.liferay.foobar.model.FooClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "permissions-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "permissions-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.sohlman.liferay.foobar.model.impl.BarImpl")) {
        ...
        if (oldModelClassName.equals(
                    "com.sohlman.liferay.foobar.model.impl.FooImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.sohlman.liferay.foobar.NoSuchBarException")) {
            return new com.sohlman.liferay.foobar.NoSuchBarException();
        }

        if (className.equals("com.sohlman.liferay.foobar.NoSuchFooException")) {
            return new com.sohlman.liferay.foobar.NoSuchFooException();
        }
