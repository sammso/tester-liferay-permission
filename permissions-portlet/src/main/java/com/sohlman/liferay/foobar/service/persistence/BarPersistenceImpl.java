...
import com.sohlman.liferay.foobar.NoSuchBarException;
import com.sohlman.liferay.foobar.model.Bar;
import com.sohlman.liferay.foobar.model.impl.BarImpl;
import com.sohlman.liferay.foobar.model.impl.BarModelImpl;
...
public class BarPersistenceImpl extends BasePersistenceImpl<Bar>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUP = new FinderPath(BarModelImpl.ENTITY_CACHE_ENABLED,
            BarModelImpl.FINDER_CACHE_ENABLED, BarImpl.class,
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP = new FinderPath(BarModelImpl.ENTITY_CACHE_ENABLED,
            BarModelImpl.FINDER_CACHE_ENABLED, BarImpl.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroup",
            new String[] { Long.class.getName() },
            BarModelImpl.GROUPID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_GROUP = new FinderPath(BarModelImpl.ENTITY_CACHE_ENABLED,
            BarModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByGroup",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_GROUP_GROUPID_2 = "bar.groupId = ?";
    ...
    private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "bar.barId";
    private static final String _FILTER_SQL_SELECT_BAR_WHERE = "SELECT DISTINCT {bar.*} FROM perpoc_Bar bar WHERE ";
    private static final String _FILTER_SQL_SELECT_BAR_NO_INLINE_DISTINCT_WHERE_1 =
        "SELECT {perpoc_Bar.*} FROM (SELECT DISTINCT bar.barId FROM perpoc_Bar bar WHERE ";
    private static final String _FILTER_SQL_SELECT_BAR_NO_INLINE_DISTINCT_WHERE_2 =
        ") TEMP_TABLE INNER JOIN perpoc_Bar ON TEMP_TABLE.barId = perpoc_Bar.barId";
    private static final String _FILTER_SQL_COUNT_BAR_WHERE = "SELECT COUNT(DISTINCT bar.barId) AS COUNT_VALUE FROM perpoc_Bar bar WHERE ";
    private static final String _FILTER_ENTITY_ALIAS = "bar";
    private static final String _FILTER_ENTITY_TABLE = "perpoc_Bar";
    private static final String _ORDER_BY_ENTITY_ALIAS = "bar.";
    private static final String _ORDER_BY_ENTITY_TABLE = "perpoc_Bar.";
     ...
     */
    @Override
    public List<Bar> findByGroup(long groupId) throws SystemException {
     ...
     */
    @Override
    public List<Bar> findByGroup(long groupId, int start, int end)
     ...
     */
    @Override
    public Bar findByGroup_First(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchBarException, SystemException {
        Bar bar = fetchByGroup_First(groupId, orderByComparator);
     ...
     */
    @Override
    public Bar fetchByGroup_First(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Bar> list = findByGroup(groupId, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Bar findByGroup_Last(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchBarException, SystemException {
        Bar bar = fetchByGroup_Last(groupId, orderByComparator);
     ...
     */
    @Override
    public Bar fetchByGroup_Last(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Bar> list = findByGroup(groupId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Bar[] findByGroup_PrevAndNext(long barId, long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchBarException, SystemException {
        ...
        try {
            ...
            array[0] = getByGroup_PrevAndNext(session, bar, groupId,
                    orderByComparator, true);

            array[1] = bar;

            array[2] = getByGroup_PrevAndNext(session, bar, groupId,
    ...
    protected Bar getByGroup_PrevAndNext(Session session, Bar bar,
     ...
     */
    @Override
    public List<Bar> filterFindByGroup(long groupId) throws SystemException {
     ...
     */
    @Override
    public List<Bar> filterFindByGroup(long groupId, int start, int end)
        throws SystemException {
    ...
    public List<Bar> filterFindByGroup(long groupId, int start, int end,
        ...
        if (getDB().isSupportsInlineDistinct()) {
            query.append(_FILTER_SQL_SELECT_BAR_WHERE);
        } else {
            query.append(_FILTER_SQL_SELECT_BAR_NO_INLINE_DISTINCT_WHERE_1);
        }

        query.append(_FINDER_COLUMN_GROUP_GROUPID_2);

        if (!getDB().isSupportsInlineDistinct()) {
            query.append(_FILTER_SQL_SELECT_BAR_NO_INLINE_DISTINCT_WHERE_2);
        }
        ...
        if (orderByComparator != null) {
            ...
            if (getDB().isSupportsInlineDistinct()) {
                ...
                query.append(BarModelImpl.ORDER_BY_SQL);
            }
        }

        String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
                Bar.class.getName(), _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN,
                groupId);
        ...
        try {
            ...
            if (getDB().isSupportsInlineDistinct()) {
                q.addEntity(_FILTER_ENTITY_ALIAS, BarImpl.class);
            } else {
                q.addEntity(_FILTER_ENTITY_TABLE, BarImpl.class);
            }
            ...
            return (List<Bar>) QueryUtil.list(q, getDialect(), start, end);
        } catch (Exception e) {
            throw processException(e);
        } finally {
            closeSession(session);
     ...
     */
    @Override
    public Bar[] filterFindByGroup_PrevAndNext(long barId, long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchBarException, SystemException {
        if (!InlineSQLHelperUtil.isEnabled(groupId)) {
            return findByGroup_PrevAndNext(barId, groupId, orderByComparator);
        }
        ...
        try {
            ...
            array[0] = filterGetByGroup_PrevAndNext(session, bar, groupId,
                    orderByComparator, true);

            array[1] = bar;

            array[2] = filterGetByGroup_PrevAndNext(session, bar, groupId,
                    orderByComparator, false);
    ...
    protected Bar filterGetByGroup_PrevAndNext(Session session, Bar bar,
        long groupId, OrderByComparator orderByComparator, boolean previous) {
        StringBundler query = null;
    ...
    public void removeByGroup(long groupId) throws SystemException {
        for (Bar bar : findByGroup(groupId, QueryUtil.ALL_POS,
    ...
    public int filterCountByGroup(long groupId) throws SystemException {
        ...
        query.append(_FILTER_SQL_COUNT_BAR_WHERE);
    ...
    @Override
    public Bar updateImpl(com.sohlman.liferay.foobar.model.Bar bar)
        throws SystemException {
        bar = toUnwrappedModel(bar);
        ...
        if (isNew || !BarModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((barModelImpl.getColumnBitmask() &
                ...
                Object[] args = new Object[] { barModelImpl.getOriginalGroupId() };

                FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_GROUP, args);
                FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUP,
                    args);

                args = new Object[] { barModelImpl.getGroupId() };
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.sohlman.liferay.foobar.model.Bar")));
